...
export const mq = {
  ...
  shrt: "@media screen and (max-height: 600px)",
  nrml: "@media screen and (max-height: 640px)",
  tall: "@media screen and (max-height: 1200px)",
  extraTall: "@media screen and (min-height: 1201px)",
