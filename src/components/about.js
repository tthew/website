        ...
        <section id='about' className={s.about}>
          <div className={s.aboutContent}>
            ...
            <div className={s.aboutBody}>
              ...
              <p>Ever since I've been on a journey of continual self-learning, re-learning &amp; iteration.</p>
              <p>Fast forward the best part of two decades and you'll find me building &amp; helping teams to build <abbr title='Progressive Web Applications'>PWAs</abbr>, <em>web sites</em> &amp; web apps with modern Javascript stacks &amp; best practice with tools like <a href='https://nodejs.org'>Node</a>, <a href='https://webpack.com'>Webpack</a>, <a href='http://reactjs.org'>React</a>, <a href="https://storybook.js.org/">Storybook</a> &amp; <a href='https://www.gatsbyjs.org/'>Gatsby</a>.</p>
              <p>I've had a wide exposure to an array of technologies and methodologies over the years, having worked for Software Houses, Creative &amp; Digital Agencies, Startups, &amp; NGOs as well as running my own businesses.</p>
              <p>I have an eye for detail and an appreciation for aesthetics &amp; try my best to apply design thinking to all areas of my work.</p>
